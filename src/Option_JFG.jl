...
module option
      ...
      const θΨ          = :No # <:Opt>* Optimize hydraulic parameters from θ(Ψ); <:File> from save file; <:No> not available
...
#
	...
	#		MODULE: global option
	# ===========================================================
		option.data.psd = true # <true> Particle size data is available; <false> Particle size data is available
			
	# =============================================================
	#		MODULE: rock fragment
	# =============================================================
		option.rockfragment.RockFragment = true # <true> make correction for rock fragment; <false> no correction for rock fragment
		option.rockfragment.RockInjected = true # <true> rocks are injected in to the fine soils; <false> rocks are included in the bulk BulkDensity_Infilt
		option.rockfragment.RockWettable = false # <true> rocks are wettable; <false> 
