...
module checking
   ...
   # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      function CHECKING(optim)
			...
			elseif  (option.hydro.θrOpt==:ParamPsd) && ("θr"∉ optim.ParamOpt) && !(option.Psd) # Derive θr frpm PSD
				error("*** option.Hydro.θrOpt==:ParamPsd THAN option.Psd=true ***")
         ...
         elseif option.smap.UsePointKosugiBimodal && option.hydro.KunsatΨ && "Ks" ∉ optim.ParamOpt
			...
			elseif  option.hydro.HydroModel==:Kosugi && (option.smap.AddPointKosugiBimodal) && option.hydro.KunsatΨ && option.Smap
